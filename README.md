...
- Este repositório contém a solução para o desafio de programação proposto para o seletivo de estágio no Target Sistemas pela plataforma Gupy.
...
Para compilar e rodar esse projeto, siga estes passos:
1. Instale o Python
2. Clone o repositório:
   ```bash
   git clone https://github.com/GiuliaFreulon/desafio-target
   cd desafio-target
